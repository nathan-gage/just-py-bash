...
[![Coverage](https://img.shields.io/badge/coverage-api%20%2B%20parity%20%2B%20packaging-blue.svg)](https://github.com/nathan-gage/just-py-bash#testing-and-coverage)
...
See [`examples/README.md`](https://github.com/nathan-gage/just-py-bash/blob/main/examples/README.md) for run instructions.
