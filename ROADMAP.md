...
- the package can boot either the repo vendored backend or the packaged backend under `src/just_py_bash/_vendor/just-bash`

### Packaging/runtime story

The repo already has a credible packaging story:

- a packaged backend is built into `src/just_py_bash/_vendor/just-bash`
