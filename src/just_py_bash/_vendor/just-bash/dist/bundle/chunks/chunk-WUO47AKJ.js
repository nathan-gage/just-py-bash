...
// dist/commands/sqlite3/sqlite3.js
...
// dist/commands/sqlite3/formatters.js
...
async function getSqliteVersion() {
  const SQL = await DefenseInDepthBox.runTrustedAsync(() => (0, import_sql.default)());
...
function normalizeWorkerResult(result, expectedProtocolToken) {
  ...
  if (raw.dbBuffer !== null && raw.dbBuffer !== void 0) {
  ...
  return {
    ...
    dbBuffer: raw.dbBuffer === void 0 ? null : raw.dbBuffer,
